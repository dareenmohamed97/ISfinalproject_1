...
// Middleware to allow requests from any frontend that is not hosted on the same machine as the server's,  y3ni el server msh hy accept ay haga gya lel server bt3k mesh men server 3al machine fa corse by5alinin mmmmkn a accept
app.use(
  cors({
    origin: true,
    credentials: true,
...
/*
  ...
  object as req.body
  efham el request eli gayelak dh ka json l2ma urlencoded 
*/
